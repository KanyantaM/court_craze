...
class VideoPage {
  ...
  factory VideoPage.fromMap(Map<String, dynamic>? map, String videoId) {
    ...
    return VideoPage(
        ...
        viewCount:  map?['results']['results']['contents'][0]['videoPrimaryInfoRenderer']['viewCount']['videoViewCountRenderer']['shortViewCount']?['simpleText'] ?? map?['results']['results']['contents'][0]['videoPrimaryInfoRenderer']['viewCount']['videoViewCountRenderer']['extraShortViewCount']?['simpleText'],
